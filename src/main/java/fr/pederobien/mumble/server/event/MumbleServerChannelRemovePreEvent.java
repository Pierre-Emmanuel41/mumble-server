...
public class MumbleServerChannelRemovePreEvent extends MumbleServerEvent implements ICancellable {
	 ...
	 */
	public MumbleServerChannelRemovePreEvent(IMumbleServer server, IChannel channel) {
		super(server);
