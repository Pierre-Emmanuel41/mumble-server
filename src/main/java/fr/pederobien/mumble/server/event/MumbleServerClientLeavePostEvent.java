...
public class MumbleServerClientLeavePostEvent extends MumbleServerEvent {
	 ...
	 */
	public MumbleServerClientLeavePostEvent(IMumbleServer server, PlayerMumbleClient client) {
		super(server);
		this.client = client;
	}
