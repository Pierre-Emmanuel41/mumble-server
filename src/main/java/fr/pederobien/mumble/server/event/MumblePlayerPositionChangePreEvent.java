...
public class MumblePlayerPositionChangePreEvent extends MumblePlayerEvent implements ICancellable {
	 ...
	 */
	public MumblePlayerPositionChangePreEvent(IPlayer player, double x, double y, double z, double yaw, double pitch) {
		super(player);
		this.x = x;
		this.y = y;
		this.z = z;
