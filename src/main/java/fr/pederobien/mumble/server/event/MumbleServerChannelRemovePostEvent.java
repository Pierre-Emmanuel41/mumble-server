...
public class MumbleServerChannelRemovePostEvent extends MumbleServerEvent {
	 ...
	 */
	public MumbleServerChannelRemovePostEvent(IMumbleServer server, IChannel channel) {
		super(server);
