...
public class MumbleParameterValueChangePreEvent extends MumbleParameterEvent implements ICancellable {
	 ...
	 */
	public MumbleParameterValueChangePreEvent(IParameter<?> parameter, Object newValue) {
		super(parameter);
