...
public class MumblePlayerListPlayerRemovePreEvent extends MumblePlayerListEvent implements ICancellable {
	 ...
	 */
	public MumblePlayerListPlayerRemovePreEvent(IChannelPlayerList list, IPlayer player) {
		super(list);
		this.player = player;
	}
