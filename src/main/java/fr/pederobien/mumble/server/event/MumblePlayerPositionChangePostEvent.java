...
public class MumblePlayerPositionChangePostEvent extends MumblePlayerEvent {
	 ...
	 */
	public MumblePlayerPositionChangePostEvent(IPlayer player, double x, double y, double z, double yaw, double pitch) {
		super(player);
		this.x = x;
		this.y = y;
		this.z = z;
