...
public class MumblePlayerListPlayerAddPostEvent extends MumblePlayerListEvent {
	 ...
	 */
	public MumblePlayerListPlayerAddPostEvent(IChannelPlayerList list, IPlayer player) {
		super(list);
		this.player = player;
	}
