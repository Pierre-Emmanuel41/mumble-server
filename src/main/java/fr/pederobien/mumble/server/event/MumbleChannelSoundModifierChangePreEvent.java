...
public class MumbleChannelSoundModifierChangePreEvent extends MumbleChannelEvent implements ICancellable {
	 ...
	 */
	public MumbleChannelSoundModifierChangePreEvent(IChannel channel, ISoundModifier currentSoundModifier, ISoundModifier newSoundModifier) {
		super(channel);
