...
public class SoundModifierRegisterPreEvent extends SoundModifierEvent implements ICancellable {
	 ...
	 */
	public SoundModifierRegisterPreEvent(ISoundModifier soundModifier) {
		super(soundModifier);
	}
