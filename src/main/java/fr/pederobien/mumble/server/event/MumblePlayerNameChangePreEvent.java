...
public class MumblePlayerNameChangePreEvent extends MumblePlayerEvent implements ICancellable {
	 ...
	 */
	public MumblePlayerNameChangePreEvent(IPlayer player, String newName) {
		super(player);
