...
public class MumbleServerClientRemovePostEvent extends MumbleServerEvent {
	 ...
	 */
	public MumbleServerClientRemovePostEvent(IMumbleServer server, PlayerMumbleClient client) {
		super(server);
		this.client = client;
	}
