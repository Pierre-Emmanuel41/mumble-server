...
public class MumblePlayerMuteByChangePreEvent extends MumblePlayerEvent implements ICancellable {
	 ...
	 */
	public MumblePlayerMuteByChangePreEvent(IPlayer target, IPlayer source, boolean newMute) {
		super(target);
		this.source = source;
