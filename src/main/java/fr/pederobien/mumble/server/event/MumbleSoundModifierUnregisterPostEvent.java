...
public class MumbleSoundModifierUnregisterPostEvent extends MumbleSoundModifierEvent {
	 ...
	 */
	public MumbleSoundModifierUnregisterPostEvent(ISoundModifier soundModifier) {
		super(soundModifier);
	}
