...
public class MumbleServerPlayerRemovePostEvent extends MumbleServerPlayerListEvent {
	 ...
	 */
	public MumbleServerPlayerRemovePostEvent(IServerPlayerList list, IPlayer player) {
		super(list);
		this.player = player;
	}
