...
public class MumbleSoundModifierUnregisterPreEvent extends MumbleSoundModifierEvent implements ICancellable {
	 ...
	 */
	public MumbleSoundModifierUnregisterPreEvent(ISoundModifier soundModifier) {
		super(soundModifier);
	}
